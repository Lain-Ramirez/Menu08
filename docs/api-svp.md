...
| Campo | Significado |
|---|---|
| `turno` | Identificador del turno vigente, o `null` si no hay ninguno abierto |
...
No es un error: el truck simplemente no está vendiendo. El tablero muestra la pantalla vacía.
...
Cada respuesta se resuelve con **dos sentencias preparadas**: una para las órdenes y otra para
sus ítems. El turno vigente se localiza con una subconsulta dentro de cada una, en vez de gastar
